...
export class ChoiceSystem {
  ...
  static init(): void {
    // 共通ルートの選択肢
    this.addChoice('opening', 2, '開発において最も重要なことは何だと思いますか？', [
      { id: 'test_first', text: 'テストを最初に書くこと', routeFlag: 'test_driven', value: 1 },
      { id: 'code_review', text: 'コードレビューを徹底すること', routeFlag: 'review_focus', value: 1 },
      { id: 'user_experience', text: 'ユーザー体験を最優先すること', routeFlag: 'ux_focus', value: 1 }
    ]);

    this.addChoice('common', 3, 'バグが見つかったときの対応は？', [
      { id: 'write_test', text: 'まずテストを書いて再現する', routeFlag: 'test_driven', value: 1 },
      { id: 'team_discussion', text: 'チームで原因を議論する', routeFlag: 'review_focus', value: 1 },
      { id: 'user_impact', text: 'ユーザーへの影響を最初に考える', routeFlag: 'ux_focus', value: 1 }
    ]);

    this.addChoice('common', 5, 'プロジェクトの成功指標は？', [
      { id: 'test_coverage', text: 'テストカバレッジの高さ', routeFlag: 'test_driven', value: 1 },
      { id: 'code_quality', text: 'コードの品質と保守性', routeFlag: 'review_focus', value: 1 },
      { id: 'user_satisfaction', text: 'ユーザー満足度', routeFlag: 'ux_focus', value: 1 }
    ]);
  }

  static addChoice(route: string, scene: number, question: string, choices: Choice[]): void {
